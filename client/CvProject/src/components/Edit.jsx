...
const CVForm = () => {
  ...
  return (
    <form className="cv-form" onSubmit={handleSubmit}>
        ...
        <div className="input-group">
          ...
          <label>
            ...
            <input
              ...
              name="job"
              defaultValue={
                info && Object.keys(info).length > 0 ? info?.job : formData?.job
              }
              onChange={(e) => handleInputChange(e)}
              required
            />
      ...
      <div className="section">
        <h2>Experience</h2>
        {formData && formData?.experience?.map((exp, index) => (
          <div className="input-group" key={index}>
            <label>
              Title:
              {console.log(info?.experience, "this is")}
              <input
                type="text"
                name="title"
                defaultValue={
            ...
            <label>
              ...
              <input
                ...
                defaultValue={
                  info && Object.keys(info).length > 0
                    ? info?.experience[index]?.location
                    : info?.experience[index]?.location
                }
                onChange={(e) => handleInputChange(e, "experience", index)}
                required
            ...
            <label>
              ...
              <input
                ...
                defaultValue={
                  info && Object.keys(info).length > 0
                    ? info?.experience[index]?.startYear
                    : info?.experience[index]?.startYear
                }
                onChange={(e) => handleInputChange(e, "experience", index)}
                required
          ...
          <div className="input-group" key={index}>
            <label>
              ...
              <input
                ...
                defaultValue={
                  info && Object.keys(info).length > 0
                    ? info?.TechStacks[index]?.TechStack
                    : info?.TechStacks[index]?.TechStack
                }
